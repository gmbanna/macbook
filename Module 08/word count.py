paragraph = "Paragraphs are the building blocks of papers. " \
            ...
            "whether a section in a paper is a paragraph. For instance, " \
            "in some styles of writing, particularly journalistic styles," \
            " a paragraph can be just one sentence long. Ultimately, a paragraph " \
...
print('Total word count : ',len(test))

paragraph2 = "a section in a paper is a paragraph"

test2 = paragraph2.split( )
# print(len(test2))
